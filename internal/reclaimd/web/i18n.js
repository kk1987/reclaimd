...
export const DICT = {
  zh: {
    ...
    'reason.SCAN_RESUME_PARTIAL': '这趟只读到 {covered_pct}% 就熔断了，不算一整趟，所以 {resume_h} 小时后从断点续扫，而不是等满 {value_h} 小时。',
  ...
  en: {
    ...
    'reason.SCAN_RESUME_PARTIAL': 'This pass stopped at {covered_pct}% of the disk, so it does not count as a full one: resuming from the cursor in {resume_h}h instead of waiting the full {value_h}h.',
